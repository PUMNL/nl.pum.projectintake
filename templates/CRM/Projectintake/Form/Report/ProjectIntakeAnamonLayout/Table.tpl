        ...
        {foreach from=$rows item=row key=rowid}
           {eval var=$sectionHeaderTemplate}
            <tr  class="{cycle values="odd-row,even-row"} {$row.class} crm-report" id="crm-report_{$rowid}">
                <td>
                        <span id="projectintake_anamonreport{$row.civicrm_case_id}_show">
                            <a href="#" onclick="
                                    projectintake_anamonreportCaseDetails('{$row.civicrm_case_id}','{$row.civicrm_contact_a_id}');
                        ...
                        <span id="minusprojectintake_anamonreport{$row.civicrm_case_id}_hide" style="display: none;">
            ...
            <tr id="projectintake_anamonreport_{$row.civicrm_case_id}_hide" class="crm-case_{$row.civicrm_case_id} crm-report" style="display: none;">
                <td></td>
                <td colspan="{$columnCount}" width="99%" class="enclosingNested crm-case_{$row.civicrm_case_id}">
                    <div id="projectintake_anamon-report-casedetails-{$row.civicrm_case_id}"></div>
                </td>
            </tr>
        {/foreach}
